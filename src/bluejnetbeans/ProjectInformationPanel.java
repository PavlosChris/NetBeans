...
public class ProjectInformationPanel extends javax.swing.JPanel {
     ...
     */
    public ProjectInformationPanel(BlueJNetBeansMyCode newReference) {
    ...
    private void initComponents() {
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 37, 40, 590));

        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Monospaced", 0, 12)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("------------------------------------------------------------------------\nThis is the project README file. Here, you should describe your project.\nTell the reader (someone who does not know anything about this project)\nall he/she needs to know. The comments should usually include at least:\n------------------------------------------------------------------------\n\nPROJECT TITLE:\nPURPOSE OF PROJECT:\nVERSION or DATE:\nHOW TO START THIS PROJECT:\nAUTHORS:\nUSER INSTRUCTIONS:\n");
        add(jTextArea1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 40, 780, 590));
